...
const HeroSection = () => {
  ...
  return (
    <section
      id="home"
      className="relative z-10 mt-24 md:mt-32 lg:mt-40 mx-6 md:mx-12 lg:mx-24 flex flex-col items-start text-white px-4"
    >
      <motion.h1
      ...
      <motion.button
  className="mt-4 px-3 py-2 md:px-5 md:py-3 rounded-full bg-gradient-to-r from-pink-500 to-purple-700 shadow-lg text-white hover:from-pink-400 hover:to-purple-600 transition duration-300"
  initial={{ opacity: 0 }}
  animate={{ opacity: 1 }}
